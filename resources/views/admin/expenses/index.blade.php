    ...
    <div class="col-md-12">
        ...
        <div class="kt-portlet">
            ...
            <div class="kt-portlet__body">
                    <a href="{{ route('expenses.create',['company'=>$company->id]) }}" class="btn btn-bold btn-secondary  flex-1 flex-grow-0 btn-border-radius mr-auto">
                        <span class="plus-class">+</span>{{ __('Create') }}
                            ...
                            <x-table :tableClass="'kt_table_with_no_pagination_no_fixed  removeGlobalStyle ' ">
                                ...
                                <tr class=" text-center first-tr-bg ">
                                    <td class="max-w-80 text-center"><b class="text-capitalize">{{ __('Name') }}</b></td>
                                ...
                                <tr class="row{{ $id }}  text-center sub-item-row" style="display: none">
                                    ...
                                    <td class="text-left text-capitalize"><b class="ml-3">
                                            <span style="overflow: visible; position: relative; width: 110px;">
                                                <a type="button" class="btn btn-secondary btn-outline-hover-brand btn-icon" title="Edit" href="{{ route('expenses.edit', ['company'=>$company->id , 'expense'=>$subItemArr['id']]) }}"><i class="fa fa-pen-alt"></i></a>
                                                ...
                                                <div id="modal-delete-{{ $subItemArr['id'] }}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <form action="{{ route('expenses.destroy',['company'=>$company->id , 'expense'=> $subItemArr['id'] ]) }}" method="post" id="delete_form">
                                                                {{ csrf_field() }}
                                                                {{ method_field('DELETE') }}
