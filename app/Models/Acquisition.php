...
class  Acquisition extends Model 
{
	...
	public function getHardConstructionStartDate(HospitalitySector $hospitalitySector)
	{
		return $this->hard_construction_start_date ?: $hospitalitySector->getDevelopmentStartDate() ;
	}
	...
	public function getSoftConstructionStartDate(HospitalitySector $hospitalitySector)
	{
		return $this->soft_construction_start_date ?: $hospitalitySector->getDevelopmentStartDate() ;
	}
	public function getSoftConstructionStartDateFormatted(HospitalitySector $hospitalitySector)
	{
		...
		return $hospitalitySector->getDevelopmentStartDate() ;
	}
...
public function getSoftCollectionPolicyValue():array 
		...
		public function getSoftConstructionStartDateIndex(HospitalitySector $hospitalitySector):int 
	{
		return $hospitalitySector->getSoftConstructionStartDate();
